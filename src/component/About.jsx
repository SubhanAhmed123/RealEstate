          ...
          <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20 ' >
              ...
              <div className='flex flex-col items-center md:items-start mt-10 text-gray-600 ' >
                  <div className='grid grid-cols-2 gap:6 md:gap-10 w-full 2xl:pr-28 ' >
                      ...
                      <p className='my-10 max-w-lg w-full' >
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo ratione pariatur ducimus delectus facilis architecto! Aperiam quaerat itaque error sapiente, nihil repudiandae explicabo eos assumenda at eligendi voluptates odio molestias.
                  </p>
                  <button className='text-white px-8 py-2 rounded  bg-blue-600' >
                      Learn More
                  </button>
